...
EMPTY_STATE_MESSAGE = (
    "Preencha o formulário e clique em 'Analisar período' para gerar o resultado."
)
...
- O CDI diário vem da série 12 do SGS/BCB e é acumulado pela regra `data_inicial_efetiva <= data < data_final_efetiva`.
...
- Esta análise é uma comparação histórica com dados oficiais; não é recomendação de investimento.
"""
